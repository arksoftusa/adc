...
- **You MUST** document your progress, failing attempts, and any environment issues in `.adc/agent-workspace/scratchpad/session.md` before concluding your current task or taking a break.
