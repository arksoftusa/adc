...
- **2026-03-23**: Added RepoDepot integration policy in `standards/conventions/devops.md` to require onboarding via `http://192.168.1.239:18080/getstarted` and enforce PR traceability/MCP alignment.
